...
public class PBKDF2Util {
	 ...
	 * 生成密文的长度
	 */
	public static final int HASH_BIT_SIZE = 250;
	...
	public static boolean authenticate(String attemptedPassword, String encryptedPassword, String salt)
		...
		System.out.println(encryptedAttemptedPassword);// 把加密后的密文和原密文进行比较，相同则验证成功，否则失败
	...
	/*public static void main(String[] args) {
		...
		try {
			...
			ciphertext = PBKDF2Util.getEncryptedPassword(password, salt);
			System.out.println(ciphertext);
			boolean result = PBKDF2Util.authenticate(password, ciphertext, salt);
